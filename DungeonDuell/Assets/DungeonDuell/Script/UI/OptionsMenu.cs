...
namespace dungeonduell
{
    public class OptionsMenu : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (canvasGroup == null) canvasGroup = optionsPanel.AddComponent<CanvasGroup>();
        ...
        {
            if (dataManager != null) dataManager.SetMusicVolume(volume);
        }

        public void SetSFXVolume(float volume)
        {
            if (dataManager != null) dataManager.SetSFXVolume(volume);
        }

        public void MuteToggle(bool muted)
        {
            if (dataManager != null) dataManager.MuteToggle(muted);
        }
        ...
        private void SetupResolutionDropdown()
        {
            ...
            if (dataManager != null) resolutionDropdown.value = dataManager.ResolutionIndex;
        ...
        {
            if (dataManager != null) dataManager.SetFullscreen(isFullscreen);
        }

        public void SetResolution(int resolutionIndex)
        {
            if (dataManager != null) dataManager.SetResolution(resolutionIndex);
        }
